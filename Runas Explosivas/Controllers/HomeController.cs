...
namespace Runas_Explosivas.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Articulo(int blogpostID)
        {
            ...
            Tags TagPodcast = new Tags();
            TagPodcast.Nombre = ".podcast";
            TagPodcast.Glyphicon = "headphones";
            TagPodcast.Prioridad = true;

            Tags TagEditorial = new Tags();
            TagEditorial.Nombre = ".editorial";
            TagEditorial.Glyphicon = "book";
            TagEditorial.Prioridad = true;
